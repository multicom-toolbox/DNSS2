...
$files		="scripts/PredictSS.pl,lib/DN_SSpred.pm,lib/DN_SSpred2.pm,./run_DNSS2.pl,./train_DNSS2/lib/evaluation_ss_prediction.pl,./train_DNSS2/lib/evaluation_ss_prediction_ss8.pl";
