...
output_dir=$GLOBAL_PATH/output/model_train_ResSS_3class
acclog_dir=$GLOBAL_PATH/output//evaluate_3class/

python $GLOBAL_PATH/train_DNSS2/models/Resnet1Dconv_ss/scripts/train_deepcovResnet_ss_3class.py  15 37 41 nadam '5'  100 3  $feature_dir $output_dir 25
