...
import time
data_all_dict_padding = load_train_test_data_padding_with_interval_8class(train_datafile, feature_dir, inter,5000, 'deepss_1dResnet')
testdata_all_dict_padding = load_train_test_data_padding_with_interval_8class(val_datafile, feature_dir, inter,5000, 'deepss_1dResnet')

start_time = time.time()
DeepSS_1dconv_train_win_filter_layer_opt_fast_8class(data_all_dict_padding,testdata_all_dict_padding,train_datafile,test_datafile,val_datafile,CV_dir, feature_dir,"deepss_1dResnet",out_epoch,in_epoch,inter,5000,filetsize_array,True,'sigmoid',nb_filters,nb_layers,opt,lib_dir, batchsize)
