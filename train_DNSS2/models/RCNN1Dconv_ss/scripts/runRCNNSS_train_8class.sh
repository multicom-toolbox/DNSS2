...
# python $GLOBAL_PATH/models/RCNN1Dconv_ss/scripts/train_deepcovRCNN_ss_8class.py  15 35 5 nadam '3'  100 3  $feature_dir $output_dir 25
python $GLOBAL_PATH/lib/test_dnss_8class.py $GLOBAL_PATH/datasets/dnss2_train.lst  15 35 5 nadam '3' $feature_dir $output_dir $acclog_dir 'deepss_1dRCNN' 'train' 25
