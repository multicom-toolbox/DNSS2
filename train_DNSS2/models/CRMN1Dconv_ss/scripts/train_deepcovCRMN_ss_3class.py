...
import time
data_all_dict_padding = load_train_test_data_padding_with_interval(train_datafile, feature_dir, inter,5000, 'deepss_1dCRMN')
testdata_all_dict_padding = load_train_test_data_padding_with_interval(val_datafile, feature_dir, inter,5000, 'deepss_1dCRMN')

start_time = time.time()
DeepSS_1dconv_train_win_filter_layer_opt_fast(data_all_dict_padding,testdata_all_dict_padding,train_datafile,test_datafile,
