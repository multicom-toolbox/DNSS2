...
feature_dir=$GLOBAL_PATH/datasets/newfeature/features_win1_with_atch_hmmEm_hmmTr_hhblitsMSA_no_aas
output_dir=$GLOBAL_PATH/output/model_train_FracNetSS_win1
acclog_dir=$GLOBAL_PATH/output//evaluate/paper_review

# python $GLOBAL_PATH/models/FracNet1Dconv_ss/scripts/train_deepcovFracNet_ss_3class.py  15 40 3 nadam '6'  100 3  $feature_dir $output_dir 25
