...
output_dir=$GLOBAL_PATH/output/model_train_CNNSS_win1_8class
acclog_dir=$GLOBAL_PATH/output/evaluate_8class/

python $GLOBAL_PATH/train_DNSS2/models/Deep1Dconv_ss/scripts/train_deepcov_ss_8class.py  15  40 5 nadam '6'  100 3  $feature_dir $output_dir 25
